...
n0=3
r=rgev_p1k3_cp(n=10000,x=x,t=tt,n0=n0,t0=NA,rust=TRUE)
plot(density(r$ml_deviates),
	sub="(from rgev_p1k3_cp)",
...
np=10000
pp=(c(1:np)-0.5)/np
pdfs_qq=qgev_p1k3_cp(x=x,t=tt,n0=n0,p=pp,pdf=TRUE,rust=TRUE)
pdfs=dgev_p1k3_cp(x=x,t=tt,n0=n0,y=xax,rust=TRUE)
cdfs=pgev_p1k3_cp(x=x,t=tt,n0=n0,y=xax,rust=TRUE)
#
plot(xax,pdfs$ml_pdf,"l",
	sub="(from dgev_p1k3_cp, qgev_p1k3_cp)",
	main="PDF")
