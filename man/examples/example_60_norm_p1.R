...
n0=3
r=rnorm_p1_cp(100000,x,tt,n0=n0,rust=TRUE)
plot(density(r$ml_deviates),
	sub="(from rnorm_p1_cp)",
...
n0=3
xax=c(-100:100)/20
pdfs=dnorm_p1_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
cdfs=pnorm_p1_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
#
plot(xax,pdfs$ml_pdf,"l",
	sub="(from dnorm_p1_cp)",
	main="PDF")
