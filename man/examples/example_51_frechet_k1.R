...
r=rfrechet_k1_cp(100000,x,rust=TRUE)
plot(density(r$ml_deviates),
	sub="(from rfrechet_k1_cp)",
	xlim=c(0,5),
...
xax=c(1:200)/20
pdfs=dfrechet_k1_cp(x,xax,rust=TRUE)
cdfs=pfrechet_k1_cp(x,xax,rust=TRUE)
#
plot(xax,pdfs$ml_pdf,"l",
	sub="(from dfrechet_k1_cp)",
	main="PDF")
