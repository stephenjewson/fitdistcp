...
n0=3
r=rfrechet_p2k1_cp(1000,x,tt,n0=n0,rust=TRUE)
plot(density(r$ml_deviates),
	sub="(from rfrechet_p2k1_cp)",
	xlim=c(0,10),
...
n0=3
xax=c(1:100)/10
pdfs=dfrechet_p2k1_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
cdfs=pfrechet_p2k1_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
#
plot(xax,pdfs$ml_pdf,"l",
	sub="(from dfrechet_p2k1_cp)",
	main="PDF")
