...
n0=3
r=rgumbel_p1_cp(100000,x,tt,n0=n0,rust=TRUE)
plot(density(r$ml_deviates),
	sub="(from rgumbel_p1_cp)",
...
n0=3
xax=c(-50:100)/20
pdfs=dgumbel_p1_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
cdfs=pgumbel_p1_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
#
plot(xax,pdfs$ml_pdf,"l",
	sub="(from dgumbel_p1_cp)",
	main="PDF")
