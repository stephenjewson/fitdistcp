...
n0=3
r=rweibull_p2_cp(1000,x,tt,n0=n0,rust=TRUE)
plot(density(r$ml_deviates),
	sub="(from rweibull_p2_cp)",
...
n0=3
xax=c(1:100)/10
pdfs=dweibull_p2_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
cdfs=pweibull_p2_cp(x=x,t=tt,t0=NA,n0=n0,y=xax,rust=TRUE)
#
plot(xax,pdfs$ml_pdf,"l",
	sub="(from dweibull_p2_cp)",
	main="PDF")
